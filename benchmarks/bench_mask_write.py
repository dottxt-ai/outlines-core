...
"""
ASV benchmark for write_mask_into method in outlines-core.
...
class MaskWriteBenchmark:
    ...
    TOKEN_PATTERNS = [
        ...
        (2500, "([0-9]|[1-9][0-9]|[1-9][0-9][0-9]|1[0-9][0-9][0-9]|2[0-4][0-9][0-9])"), # 2500 tokens
        (5000, "([0-9]|[1-9][0-9]|[1-9][0-9][0-9]|[1-4][0-9][0-9][0-9])"), # 5000 tokens
        (7500, "([0-9]|[1-9][0-9]|[1-9][0-9][0-9]|[1-6][0-9][0-9][0-9]|7[0-4][0-9][0-9])"), # 7500 tokens
        (10000, "([0-9]|[1-9][0-9]|[1-9][0-9][0-9]|[1-9][0-9][0-9][0-9])") # 10000 tokens
    ]
    ...
    def track_allowed_token_count(self, allowed_tokens):
        """
        Track the actual number of allowed tokens for verification.
        """
        return len(self.guide.get_tokens())